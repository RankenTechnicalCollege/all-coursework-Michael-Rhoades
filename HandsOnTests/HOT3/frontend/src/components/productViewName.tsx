...
export function ProductViewName() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/products/name/${productName}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.patch(`${import.meta.env.VITE_API_URL}/products/name/`, validatedData);
