...
export function ProductCreate({ showError, showSuccess }: { showError: (message: string) => void; showSuccess: (message: string) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/products`, validatedData);
